...
const Feedback = ({navigation}) => {
    ...
    const Submitdata = () => {
        ...
        {console.log(data)}
        ApisService.share_feedback(data)
    ...
    return (
        <View>
            <Text style={styles.textcontaner}>your feedback is important to us. always happy to hear from you.</Text>
            <View style={styles.inercontener}>
                < TextInput
                    style={styles.inputcontainer}
                    placeholder="wrire your feedback."
                    autoCapitalize="none"
